...
public class LoginDoctor extends javax.swing.JFrame {
    ...
    public LoginDoctor() {
     ...
     private boolean verifyDoctor(int id, String password){
         ConnectionMaker aConnectionMaker = new ConnectionMaker();        
       if(aConnectionMaker.verifyDoctor0(id, password))
           return true;
       else
        return false;
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        // TODO add your handling code here:
           ...
           if(verifyDoctor(Integer.parseInt(jTextField1.getText()), jTextField2.getText())){
            DoctorOptionScreen apScreen = new DoctorOptionScreen();
