...
public class LoginPatient extends javax.swing.JFrame {
     ...
     */
    private boolean verifyUser(int id, String password){
        ConnectionMaker aConnectionMaker = new ConnectionMaker();        
       if(aConnectionMaker.verifyUser0(id, password))
           return true;
       else
        return false;
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        // TODO add your handling code here:
        if(verifyUser(Integer.parseInt(jTextField1.getText()),jTextField2.getText())){
            RecordOfficerOptionsScreen apScreen = new RecordOfficerOptionsScreen();
            ...
            jTextField1.setText("");
            jTextField2.setText("");
           jLabel5.setText("Error in id or Password");
         }
